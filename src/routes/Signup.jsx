        ...
        <div className='flex flex-col justify-center items-center w-full h-screen '>
            {(loading) ? <p>Cargando</p>
                : <div className="form flex flex-col justify-center items-center w-4/5 p-2">
                    <input className='input input-bordered input-primary mb-2 w-full' type="text" name="fullname" id="fullname" placeholder='Escribe tu nombre completo' value={query.fullname} onChange={(e) => setQuery({ ...query, fullname: e.target.value })} />
                    <input className='input input-bordered input-primary mb-2 w-full' type="text" name="username" id="username" placeholder='Escribe tu nombre de usuario' value={query.username} onChange={(e) => setQuery({ ...query, username: e.target.value })} />
                    ...
                    <button className='btn btn-primary w-full' onClick={signupHandler}>Ingresar</button>
                </div>}
        </div>
    )
}
